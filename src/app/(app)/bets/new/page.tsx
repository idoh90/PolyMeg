...
const SUGGESTIONS = [
  "אופק יחזור לאקסית עד סוף החודש?",
  "אידו ייכנס להריון השנה?",
  "עמרי יגיע בזמן ולו פעם אחת בחיים?",
  "אלעד יסיים מרתון בלי לעצור לסלפי?",
  "ינאי יזמין את כולם לדינר ולא יתחרט?",
  "מי מהחבר׳ה יתחתן ראשון?",
  "אופק ישבור טלפון נוסף החודש?",
  "עמרי יענה להודעה תוך פחות מ-3 שעות?",
  "אלעד יתחיל דיאטה וישרוד שבוע שלם?",
  "ינאי יוריד את המשחק החדש לפני כולם?",
  "אידו יקנה אייפון חדש ויתחרט?",
  "מי יפספס את הטיסה הקרובה?",
  "אופק יחליף תספורת ויתחרט תוך יום?",
  "עמרי יתחיל חדר כושר וימשיך חודש?",
  "אלעד יירדם ראשון במסיבה?",
  "ינאי ישכח יום הולדת של מישהו מהחבר׳ה?",
  "אידו יזכה בהימור הזה בכלל?",
  "מי ישלם הכי הרבה על קפה החודש?",
  "אופק יתארס לפני סוף השנה?",
  "עמרי יוריד שוב אפליקציית דייטינג?",
  "אלעד יחטוף קנס חניה החודש?",
  "ינאי ינצח את כולם בפיפא הערב?",
  "אידו יגדל זקן עד החורף?",
  "מי יאכל הכי הרבה בדינר הקרוב?",
  "אופק יבטל תוכניות ברגע האחרון (שוב)?",
  "עמרי יקנה גאדג׳ט חדש ולא ישתמש בו?",
  "אלעד ישכח איפה החנה את האוטו?",
  "ינאי יעבור דירה עד הקיץ?",
  "מי יישן הכי מעט השבוע?",
  "אופק ישכנע מישהו לצאת בלילה אמצע שבוע?",
  "עמרי יישאר ער עד 4 לפנות בוקר?",
  "אלעד יקנה כרטיס להופעה וימכור ברגע האחרון?",
  "ינאי יחליף עבודה השנה?",
  "אידו יעשה כושר 3 פעמים השבוע?",
  "מי ישכח את הארנק בבית בפעם הבאה?",
  "אופק יחזיר את הכסף שהוא חייב לכולם?",
  "עמרי יזמין שווארמה אחרי חצות?",
  "אלעד יתקע בפקק יותר משעה מחר?",
  "ינאי יקנה מניה ויהפוך למיליונר?",
  "אידו יספר את אותה בדיחה בפעם המאה?",
  "מי ייכנס לזוגיות ראשון מבין כולם?",
  "אופק יתחיל ללמוד גיטרה ויפסיק תוך שבוע?",
  "עמרי ינצח את אלעד במאבק ידיים?",
  "אלעד יבריז מהאימון ביום שלישי?",
  "ינאי ישכנע את כולם להזמין סושי?",
  "אידו יאחר לחתונה של עצמו?",
  "מי יאבד את הראש ראשון על המגרש?",
  "אופק יקנה רכב יד שנייה שמתפרק תוך חודש?",
  "עמרי יבטיח להפסיק לעשן ויחזיק יומיים?",
  "אלעד יזכה בהגרלה ויעלם לחו״ל?",
];
